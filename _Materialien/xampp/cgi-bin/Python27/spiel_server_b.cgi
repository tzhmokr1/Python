...
# Ausgabe
ausgabe =  "<p>{0:d} von 5 in {1:.2f} Sekunden". \
      format(richtig, differenz)

# Highscore
if richtig == 5:
    print ausgabe, ", Highscore</p>"
    hs_lesen()
    hs_hinzu(form["spielername"].value, differenz)
    hs_schreiben()
    hs_anzeigen()
else:
    print ausgabe, ", leider kein Highscore</p>"

# Hyperlink zum Anfang
print "<p><a href='http://localhost/Python27/" \
